...
const Footer = () => {
  ...
  return (
    <motion.footer
      className="bg-dark dark:bg-gray-900 text-white py-12 rounded-t-[3rem] mt-8 transition-colors duration-300"
          ...
          <div className="flex space-x-6">
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                className="text-gray-400 hover:text-white transition duration-300 p-2 rounded-full hover:bg-white/10"
